...
* 第 2 章《相关技术分析》迁移
* 第 3 章《系统需求分析》迁移
* 第 4 章《系统设计》按 Word 主线调整
* 第 5 章《系统核心功能实现》迁移与模型发布流程图接入
* 第 6 章《手势识别服务实现与实验分析》主体迁移
* 第 3 章用例图、流程图 TikZ 化
* 第 5 章模型发布流程图接入
* 第 6 章图片智能占位图接入
* 全局表格列宽与长英文断行优化
* 本地备份文件、编译产物和虚拟环境清理规则配置
...
* `figures/chapter06/`：第六章图片资源目录，当前用于放置真实图片替换占位图
...
`.vscode/settings.json` 已配置 LaTeX Workshop 自动编译。
